  ...
  _INPUTARRAY_FIXED_TYPE =  $8000  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_FIXED_SIZE =  $4000  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_KIND_MASK =   not (_INPUTARRAY_FIXED_TYPE or _INPUTARRAY_FIXED_SIZE) - (1  shl  _INPUTARRAY_KIND_SHIFT) + 1;
  _INPUTARRAY_NONE =  0  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_MAT =  1  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_MATX =  2  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_STD_VECTOR =  3  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_STD_VECTOR_VECTOR =  4  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_STD_VECTOR_MAT =  5  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_EXPR =  6  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_OPENGL_BUFFER =  7  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_OPENGL_TEXTURE =  8  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_GPU_MAT =  9  shl  _INPUTARRAY_KIND_SHIFT;
  _INPUTARRAY_OCL_MAT =  10  shl  _INPUTARRAY_KIND_SHIFT;
