...
begin
    begin
        ...
        begin
            ...
            termcrit._type :=(CV_TERMCRIT_EPS or CV_TERMCRIT_ITER);
        ...
        pCvcvtColor(image, hsv, COLOR_BGR2HSV, 0);
        ...
        begin
            ...
            begin
                ...
                pCvnormalize(hist, hist, 0, 255.0, CV_MINMAX, -1, pCvDefaultMat);
                pCvMatDelete(hueroi);
            ...
            if( backproject_mode <> 0 ) then
                pcvCvtColor( backproject, image, COLOR_GRAY2BGR, 0 );

            {draw an ellipse around the tracked object}
           color:=CvScalar_(255,0,0,0);
           pCvellipse2(image, track_box, color, 3, CV_AA);
