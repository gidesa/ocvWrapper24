...
void     pCvCvSliceToStruct( CvSlice_t* wrapper, CvCvSliceS* dest);
void     pCvCvSliceFromStruct( CvSlice_t* wrapper, CvCvSliceS* dest);
...
void     pCvCvDTreeNodeToStruct( CvDTreeNode_t* wrapper, CvCvDTreeNodeS* dest);
void     pCvCvDTreeNodeFromStruct( CvDTreeNode_t* wrapper, CvCvDTreeNodeS* dest);
...
void     pCvCvTermCriteriaToStruct( CvTermCriteria_t* wrapper, CvCvTermCriteriaS* dest);
void     pCvCvTermCriteriaFromStruct( CvTermCriteria_t* wrapper, CvCvTermCriteriaS* dest);
